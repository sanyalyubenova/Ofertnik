    ...
    try {
        ...
        if (formData.egnActive !== undefined) {
            setTimeout(() => {
                const egnBtn = document.querySelector('.input-type-btn[data-type="egn"]');
                const birthdateBtn = document.querySelector('.input-type-btn[data-type="birthdate"]');
                if (formData.egnActive && egnBtn && !egnBtn.classList.contains('active')) {
                    egnBtn.click();
                } else if (!formData.egnActive && birthdateBtn && !birthdateBtn.classList.contains('active')) {
                    birthdateBtn.click();
                }
            }, 50);
        }
